            ...
            public void onNext(String s) {
                ...
                if(!s.isEmpty()){
                    ...
                    getActivity().runOnUiThread(() -> {
                        SearchViewModel searchViewModel = new SearchViewModel(pass_value);
                        searchViewModel.getImages().observe(getActivity(), apiResponse -> {
                            searchAdapter = new SearchAdapter(getContext(), apiResponse);
